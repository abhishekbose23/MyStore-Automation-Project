...
public class TC_loginAccountTest extends BaseClass {
	...
	public void verifyRegistrationLoginPage() {
		...
		la.name("Meera Baai");     // Enter Name
		logger.info("Enter Name");
		la.email("MeeraBaai@gmail.com");   // Enter Email
		...
		usignup.firstName("Meera");
		usignup.lastName("Baai");
	...
	String userCreated =	regUser.accountCreationText();

	Assert.assertEquals("ACCOUNT CREATED!", userCreated);
